...
const Registrar = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (password !== repetirPassword) {
      ...
      // console.log('Los pasword no son iguales');
      return;
    }
  ...
  return (
    <>
      ...
      <div className='mt-20 md:mt-5 shadow-lg px-5 py-10 rounded-xl bg-white'>
        ...
        {/* Si en mensaje hay algo entonces muestra el componente de alerta, 
          * en otro caso no muestra nada, es muy extraña esta condicional
          */}
        {msg && <Alerta 
          alerta={alerta}
        />}        
        <form onSubmit={handleSubmit}>
          ...
          <input type="submit" value="Crear Cuenta" className="bg-indigo-700 w-full py-3 px-10 rounded-xl text-white uppercase font-bold mt-5 hover:cursor-pointer hover:bg-indigo-800 md:w-auto" id="" />
        </form>
